        ...
        <div className="container">
            ...
            <div className="detail-container d-flex ">
                ...
                <div className="detail-text w-50 ms-5">
                    ...
                    <div>
                        <div className=" d-flex align-items-center">
                            <button className="detail-button col-4 orange border-0 rounded-pill text-white fw-semibold">Add to cart</button>
                            <button className="detail-button col-4 orange border-0 ms-2 rounded-pill text-white fw-semibold">Buy it now</button>
                    ...
                    <h5>Sku: 01133-9-9</h5>
                    <div className="d-flex align-items-center">
                        <h5 className="">Category:</h5> <p1 className="m-2">20%off, 49%off Alex remote</p1>
                    </div>
                    <div className="d-flex align-items-center">
