...
import UsersTableHead from "./CustomerTableHead";
import UsersTableToolbar from "./CustomerTableToolbar";
...
export default function CustomerList() {
  const URL = "https://puuzket.onrender.com/customer";
                  ...
                  .map((parametr, index) => (
                    ...
                    >
                      ...
                      <TableCell className="products-tablecell-text">
                        {parametr.customer_email}
                      </TableCell>
                      <TableCell>
                        <Chip
                          label={parametr.customer_description}
                          color="primary"
                          size="small"
                          className="chip"
                        />
                      ...
                      >
                        {parametr.customer_phone_number}
                      </TableCell>
                      <TableCell className="products-tablecell-text">
                        {parametr.customer_joined_date}
                      </TableCell>
                      <TableCell>
                        {" "}
                        <IconButton
